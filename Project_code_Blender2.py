...
cardOptions=['King_of_Dimonds','Queen_of_Spades','Queen_of_Hearts','King_of_Clubs','Ace_of_Spades','2_of_Spades','3_of_Spades','4_of_Spades','5_of_Spades','6_of_Spades','7_of_Spades','8_of_Spades','9_of_Spades']
...
def Across(anglesChoosen,numCards):
    ...
    if(answer=="1"):
        choice2=int(input("how many cards are you using"))
